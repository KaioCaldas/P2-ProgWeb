...
class VendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venda" do
    assert_difference('Venda.count') do
      post vendas_url, params: { venda: { dataVenda: @venda.dataVenda, total: @venda.total } }
    end
  ...
  test "should update venda" do
    patch venda_url(@venda), params: { venda: { dataVenda: @venda.dataVenda, total: @venda.total } }
